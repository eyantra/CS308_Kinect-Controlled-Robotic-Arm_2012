...
namespace DexterER2
{
    /*
        Class: ArmCtrl
            ...
            class which provides API for controlling the arm 
    */
    public class ArmCtrl
    {
        ...
        /*
          Function: reset
            ...
            resets all the axis angles to 90 degrees i.e., home position
        */
        public void reset()
        {
        ...
        /*
            ...
            Parameters:
               ...
               _angle_limit - arm will be restricted to move between _angle_limit and 180-_angle_limit; 
                               this is to protect the arm during testing phase against extreme angles;
                              range: 0 to 90;
                              defaults value is 0.
                              
               _speed_limit - arm will be restricted to move at speeds less than _speed_limit;
                               range: 0 to 180
                             defaults to 90.
        */
        public ArmCtrl(int _angle_limit=0, int _speed_limit=90,int _timer_period=100)
        {
            timer_period = _timer_period;
            if (_angle_limit >= 0 && _angle_limit <= 90)
            {
            ...
            if (_speed_limit >= 0 && _speed_limit <= 180)
            {
    	...
    	Parameters:
    	    ...
    	    COMPortName - name of the comport to be connected to
        ...
        */
        ...
        /*
          Function: disconnect_port()
              ...
              Disconnect from the connected comport.
        ...
        /*
         Function: IsConnected
            ...
            Test if the arm is currently connected
        ...
        /*
          Function: servo_move
            ...
            Move servo motors at a particular axis
         
          Parameters:
         
            i - axis number (Refer to Dexter ER2 manual for axis mapping);
               range: 1 to 6
         
            _angle - angle the axis will be set to;
                    range: 0 to 180;
                    will be capped according to the _angle_limit set during class instatiation
         
            _speed - speed at which the axis should be turned;
                    range: 0 to 180;
                    will be capped according to the _angle_limit set during class instatiation
        ...
        /*Move axis 1*/
        private void servo_move1(string str1, string str2)
        {
        ...
        /*Move axis 2*/
        private void servo_move4(string str1, string str2)
        {
           byte[] buffer = this.HexToByte1(str1);
           byte[] buffer2 = this.HexToByte2(str2);
           byte num = 0x23;
        ...
        /*Move axis 3*/
        private void servo_move7(string str1, string str2)
        {
           byte[] buffer = this.HexToByte1(str1);
           byte[] buffer2 = this.HexToByte2(str2);
           byte num = 0x23;
        ...
        /*Move axis 4*/
        private void servo_move10(string str1, string str2)
        {
            byte[] buffer = this.HexToByte1(str1);
            byte[] buffer2 = this.HexToByte2(str2);
            byte num = 0x23;
        ...
        /*Move axis 5*/
        private void servo_move13(string str1, string str2)
        {
            byte[] buffer = this.HexToByte1(str1);
            byte[] buffer2 = this.HexToByte2(str2);
            byte num = 0x23;
        ...
        /*Move axis 6*/
        private void servo_move16(string str1, string str2)
        {
            byte[] buffer = this.HexToByte1(str1);
            byte[] buffer2 = this.HexToByte2(str2);
            byte num = 0x23;
        ...
        /*
         * send angle and speed data to arm
         */
